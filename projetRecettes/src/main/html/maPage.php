        ...
        if(isset($_SESSION['pseudo'])){
            ...
            foreach ($test['recettes'] as $v) {
                ...
                if ($vraiuser==$pseudo){
                    ...
                    echo "<td><a href='voirrecette.php?id=$id'>$nom</a></td><td>$intr</td><td>$typerecette</td><td><a href='modif.php'><img title='Modifier la recette' src='modifier.png' width='20px' ></a></td><td><a href='deleteRecette.php?id=$id&loc=perso'><img title='Supprimer la recette' src='delete.png' width='20px'></a></td></tr>";
                }
            }
            echo "</table></br>";
